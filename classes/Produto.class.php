    ...
    public function add()
{
    ...
    $sql = "INSERT INTO $this->table (nome, descricao, idFuncionario, preco, unidade) 
            VALUES (:nome, :descricao, :idFuncionario, :preco, :unidade)";
...
public function update($campo, $idProduto)
{
    $sql = "UPDATE $this->table 
            SET nome = :nome, descricao = :descricao, preco = :preco, unidade = :unidade 
            WHERE $campo = :idProduto";
