...
public function setiIdProduto($idProduto)
    ...
    public function add()
    {
        $sql = "INSERT INTO $this->table (nome, descricao, idProduto, preco, unidade) VALUES (:nome, :descricao, :idProduto, :preco, :unidade)";
    ...
    {
        $sql = "UPDATE $this->table SET nome=:nome,descricao=:descricao,preco=:preco,unidade=:unidade WHERE $campo=:idProduto";
        $stmt = $this->db->prepare($sql);
        $stmt->bindParam(":nome", $this->nome, PDO::PARAM_STR);
