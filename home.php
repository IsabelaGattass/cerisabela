...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="images/logosite.png.png">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav flex-grow-1">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="index.php">Sobre nós</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="contato.php">Contato</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="CadastroEmpresa.php">Empresa</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="CadastroClientes.php">Cliente</a>
                        </li>
                    </ul>
                    <div class="align-self-end">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="LoginUsuario.php" class="nav-link text-white">Entrar</a>
                            </li>
                            <li class="nav-item">
            ...
            <div id="carouselMain" class="carousel slide carousel-dark" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="3000">
                        ...
                        <img src="images/carrosel/carr1.png" class="d-block d-md-none  w-100" alt="">
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                        <div class="card text-center bg-light">
                            ...
                            <a href="produto.html">
                                <img src="images/esmaltes/emt1.png" class="card-img-top">
                            </a>
                            <div class="card-header">
                                R$ 8,99
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Esmalte Risqué Léo Mandou Flores</h5>
                                <p class="card-text truncar-3l">
                                    Esmalte Cremoso 8ml
                                </p>
                            </div>
                            <div class="card-footer">
                                <a href="carrinho.php" class="btn btn-outline-info">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                        <div class="card text-center bg-light">
                            <a href="Produtos.php" class="position-absolute end-0 p-2 text-danger">
                                <i class="bi-suit-heart" style="font-size: 24px; line-height: 24px;"></i>
                            </a>
                            <img src="images/esmaltes/emt2.png" class="card-img-top">
                            </a>
                            <div class="card-header">
                                R$ 8,99
                            </div>
                            <div class="card-body">
                                <h5 class="card-title">Esmalte Risqué Rose Bombom</h5>
                                <p class="card-text truncar-3l">
                                    Esmalte Cremoso 8ml
                                </p>
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                        <div class="card text-center bg-light">
                            ...
                            <img src="images/produtos/000004.jpg" class="card-img-top">
                            <div class="card-header">
                                R$ 8,99
                            </div>
                            <div class="card-body">
