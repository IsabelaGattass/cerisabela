...
$produto = new Produto();
 ...
 if($produto-> add()) {
     echo "<script>window.alert('Produto adicionado com sucesso.'); windows.location.href=CadastroProduto.php;</script>";
    } else { 
     echo "<script>window.alert('Erro ao adicionar produto.'); window.open (document.referrer,'_self'); <script>" ;
